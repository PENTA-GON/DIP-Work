function [ n, bin ] = histogram3d2d_NoScaling( I,nbins,flag, isPlot )
...
if (flag == 0) 
    ...
    if isPlot
        ...
        title('3D histogram of three opponent color axes (No scaling)');
    ...
    if isPlot
        ...
        title('2D histogram of color constancy algorithm (No scaling)');
    end
end
